...
namespace ss_workshop{
  ...
  //                           &VelNode::TrajCallback, this);
        ...
        pub_timer_ = nh_.createTimer(ros::Duration(0.02), &VelNode::PubCallback, this,
			false);
   //      com_timer_ = nh_.createTimer(ros::Duration(0), &VelNode::ComCallback, this,
			// true, false);
	...
	void VelNode::VeloCallback(const geometry_msgs::TwistStampedConstPtr& msg){
		ROS_INFO_ONCE("Received velocity setpoint");
	...
	// void VelNode::ComCallback(const ros::TimerEvent &e){	
...
int main(int argc, char** argv) {
  ...
  ss_workshop::VelNode vel_node(nh, private_nh);
